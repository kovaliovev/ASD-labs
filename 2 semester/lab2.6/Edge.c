...
#include <stdlib.h>
/*
	Файл описує структуру даних, яка використовується для збережння інформації,
	пов'язаної з ребрами графа; а також функції потрібні для роботи з цією структурою;
