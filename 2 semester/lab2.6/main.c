...
void draw_window(HWND hWnd, HDC hdc, int drawing_flag, int kruskal_step)
{
	...
	draw_minimum_spanning_tree(hdc, spanning_tree_vertex_pen, spanning_tree_edge_pen, VERTICES_COUNT, kruskal_step, KRUSKAL_INFO_X, KRUSKAL_INFO_Y, head_vertex, head_edge);
